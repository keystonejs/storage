...
var Storage = {
	...
	pre: function (instance, method, callback) {
		...
		if (typeof method === 'function') {
			...
			if (!_.size(this._cache)) {
				throw new Error('Storage API: No instances specified. Did you forget to call init()?');
			}
			...
			this._get(instance).pre(method, callback);
		}
	...
	post: function (instance, method, callback) {
		...
		if (typeof method === 'function') {
			...
			this._get(instance).post(method, callback);
		}
	}
